...
//////////////// 
    ...
    if(stype == 0){
			...
			//設定綠血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['1000G','強化石(劣)','強化石(中)','翠風之珠(小)'];
			
			SkillTwo.length = 4;
			SkillTwo = ['【SR】風迷宮武=暴風之槍','【SR】風迷宮武=守護盾劍','【SR】風迷宮武=恩惠之杖','【SR】迷宮武=狂嵐之劍'];
		...
		times = 1
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['5000G','強化石(優)','強化石(中)','翠風之珠(中)'];
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['10000G','強化石(優)','強化石(中)','翠風之珠(大)'];
