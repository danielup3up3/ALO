...
function Hari(){
	rply.text = 'Lv.5 像是魷魚一樣的詭異生物(怪物代碼001\
				\n HP 800/800 \
	\n \
        \n 我方HP為1000 ，當受到敵人攻擊時需宣告自己的剩餘血量 宣告方式 "當前血量/最大血量" \
	\n 現在試著攻擊吧 ，請輸入"普通拳擊" 給予對手200點傷害後，再輸入指令【回合結束(代碼) (敵人剩餘血量) \
	\n 像這次就要輸入: "回合結束001 600" 非常抱歉怪物的剩餘血量需要由玩家方來計算，試著輸入看看吧! ';
	return rply;
}
