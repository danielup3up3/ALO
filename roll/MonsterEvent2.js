...
//////////////// 
    ...
    if(monsterHP >= 500000){
      ...
      }else if(monsterHP < 500000 && monsterHP >= 200000){
			//黃血區域
		times = 1
    ...
    }else if(monsterHP < 200000 && monsterHP > 0){
			//紅血區域
			times = 1
