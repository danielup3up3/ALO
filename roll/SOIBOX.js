...
//////////////// 
    ...
    if(stype == 0){
			...
			//設定綠血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['1000G','強化石(劣)','強化石(中)','大地之珠(小)'];
			
			SkillTwo.length = 4;
			SkillTwo = ['【SR】土迷宮武=巨巖之槍','【SR】土迷宮武=大地盾劍','【SR】土迷宮武=轉生之杖','【SR】土迷宮武=蓋亞之劍'];
			
			SpecialSkill.length = 4;
			SpecialSkill = ['【SSR】土迷宮武=巨巖之槍','【SSR】土迷宮武=大地盾劍','【SSR】土迷宮武=轉生之杖','【SSR】土迷宮武=蓋亞之劍'];
		...
		times = 1
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['5000G','強化石(優)','強化石(中)','大地之珠(中)'];
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['10000G','強化石(優)','強化石(中)','大地之珠(大)'];
