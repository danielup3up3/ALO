...
//////////////// 
    ...
    if(stype == 0){
			...
			//設定綠血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['1000G','強化石(劣)','強化石(中)','青海之珠(小)'];
			
			SkillTwo.length = 4;
			SkillTwo = ['【SR】水迷宮武=龍捲之槍','【SR】水迷宮武=御水盾劍','【SR】水迷宮武=朝露之杖','【SR】迷宮武=瀑布之劍'];
			
			SpecialSkill.length = 4;
			SpecialSkill = ['【SSR】水迷宮武=龍捲之槍','【SSR】水迷宮武=御水盾劍','【SSR】水迷宮武=朝露之杖','【SSR】迷宮武=瀑布之劍'];
		...
		times = 1
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['5000G','強化石(優)','強化石(中)','青海之珠(中)'];
			...
			//設定黃血攻擊模式
			SkillOne.length = 4;
			SkillOne = ['10000G','強化石(優)','強化石(中)','青海之珠(大)'];
